...
@section('page_title', __('ui.edit_class').' - '.$c->name)

@section('content')

<div class="card">
    <div class="card-header header-elements-inline">
        <h6 class="card-title">{{ __('ui.edit_class') }}</h6>
        {!! Qs::getPanelOptions() !!}
    </div>
            ...
            <div class="col-md-6">
                <form class="ajax-update" data-reload="#page-header" method="post" action="{{ route('classes.update', $c->id) }}">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-lg-9">
                            <input name="name" value="{{ $c->name }}" required type="text" class="form-control" placeholder="{{ __('ui.name_of_class') }}">
                        </div>
                    </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-lg-9">
                            <input class="form-control" disabled="disabled" value="{{ $c->class_type->name }}" title="{{ __('ui.class_type') }}" type="text">
                        </div>
                    </div>
