<html> 
<head>
    <title>{{ __('ui.timetable') }} - {{ $ttr->name.' - '.$ttr->year }}</title>
    <style>
        @media print {
...
<div class="container">
    <div id="print" xmlns:margin-top="http://www.w3.org/1999/xhtml">
            ...
            <tr>
                <td >
                    ...
                    <strong><span style="color: #000; font-size: 15px;">
                        {{ __('ui.timetable_for') }} {{ strtoupper($my_class->name. ' ('.$ttr->year.')' ) }}
                    </span></strong>
                </td>
            </tr>
        </table>
        ...
        <table cellpadding="20" style="width:100%; border-collapse:collapse; border: 1px solid #000; margin: 10px auto;" border="1">
            <thead>
            <tr>
                <th rowspan="2">{{ __('ui.time') }} <i class="icon-arrow-right7 ml-2"></i> <br> {{ __('ui.date') }} <i class="icon-arrow-down7 ml-2"></i>
                </th>
