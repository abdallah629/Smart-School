...
@section('page_title', __('ui.create_payment'))
@section('content')

<div class="card">
    <div class="card-header header-elements-inline">
        <h6 class="card-title">{{ __('ui.create_payment') }}</h6>
        {!! Qs::getPanelOptions() !!}
    </div>
            ...
            <div class="col-md-6">
                <form class="ajax-store" method="post" action="{{ route('payments.store') }}">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-lg-9">
                            <input name="title" value="{{ old('title') }}" required type="text" class="form-control" placeholder="{{ __('ui.example_school_fees') }}">
                        </div>
                    </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-lg-9">
                            <select class="form-control select" name="method" id="method">
                                <option selected value="Cash">{{ __('ui.cash') }}</option>
                                <option disabled value="Online">{{ __('ui.online') }}</option>
                            </select>
                        </div>
                    </div>

                    <div class="form-group row">
                        <label for="amount" class="col-lg-3 col-form-label font-weight-semibold">{{ __('ui.amount') }} (<del style="text-decoration-style: double">N</del>) <span class="text-danger">*</span></label>
                        <div class="col-lg-9">
