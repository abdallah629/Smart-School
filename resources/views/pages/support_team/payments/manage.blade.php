...
@section('page_title', __('ui.student_payments'))
@section('content')
<div class="card">
    <div class="card-header header-elements-inline">
        <h5 class="card-title"><i class="icon-cash2 mr-2"></i> {{ __('ui.student_payments') }}</h5>
        {!! Qs::getPanelOptions() !!}
    </div>
        ...
        <table class="table datatable-button-html5-columns">
            ...
            @foreach($students as $s)
                <tr>
                    ...
                    <td>
                        <div class="dropdown">
                            <a href="#" class=" btn btn-danger" data-toggle="dropdown"> {{ __('ui.manage_payments') }} <i class="icon-arrow-down5"></i>
                            </a>
                            <div class="dropdown-menu dropdown-menu-left">
                                <a href="{{ route('payments.invoice', [Qs::hash($s->user_id)]) }}" class="dropdown-item">{{ __('ui.all_payments') }}</a>
