...
@section('page_title', __('ui.user_profile') . ' - ' . $user->name)
@section('content')
    <div class="row">
                    ...
                    <div class="tab-content">
                        ...
                        <div class="tab-pane fade show active" id="basic-info">
                            <table class="table table-bordered">
                                ...
                                @if($user->username)
                                    <tr>
                                        <td class="font-weight-bold">{{ __('ui.username') }}</td>
                                        <td>{{$user->username}}</td>
                                    </tr>
                                @endif
                                @if($user->phone)
                                ...
                                @if($user->user_type == 'parent')
                                    <tr>
                                        <td class="font-weight-bold">{{ __('ui.children_ward') }}</td>
                                        <td>
                                ...
                                @if($user->user_type == 'teacher')
                                    <tr>
                                        <td class="font-weight-bold">{{ __('ui.my_subjects') }}</td>
                                        <td>
