...
@section('page_title', __('ui.edit_user'))
@section('content')

    <div class="card">
        <div class="card-header header-elements-inline">
            <h6 class="card-title">{{ __('ui.edit_user_details') }}</h6>
            {!! Qs::getPanelOptions() !!}
        </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <input value="{{ $user->name }}" required type="text" name="name" placeholder="{{ __('ui.full_name') }}" class="form-control">
                            </div>
                        </div>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input value="{{ $user->address }}" class="form-control" placeholder="{{ __('ui.address') }}" name="address" type="text" required>
                            </div>
                        </div>
                    </div>
                        ...
                        @if(in_array($user->user_type, Qs::getStaff()))
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input autocomplete="off" name="emp_date" value="{{ $user->staff->first()->emp_date ?? '' }}" type="text" class="form-control date-pick" placeholder="{{ __('ui.select_date') }}">
                                </div>
                            </div>
                        @endif
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <select class="select form-control" id="gender" name="gender" required data-fouc data-placeholder="{{ __('ui.choose') }}">
                                    <option value=""></option>
                                    <option {{ ($user->gender == 'Male') ? 'selected' : '' }} value="Male">{{ __('ui.male') }}</option>
                                    <option {{ ($user->gender == 'Female') ? 'selected' : '' }} value="Female">{{ __('ui.female') }}</option>
                                </select>
                            </div>
                        </div>
