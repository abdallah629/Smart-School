...
@section('page_title', __('ui.edit_grade'))

@section('content')

<div class="card">
    <div class="card-header header-elements-inline">
        <h6 class="card-title">{{ __('ui.edit_grade') }}</h6>
        {!! Qs::getPanelOptions() !!}
    </div>
            ...
            <div class="col-md-6">
                <form method="post" action="{{ route('grades.update', $gr->id) }}">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-lg-9">
                            <input name="name" value="{{ $gr->name }}" required type="text" class="form-control" placeholder="{{ __('ui.eg_c4') }}">
                        </div>
                    </div>
