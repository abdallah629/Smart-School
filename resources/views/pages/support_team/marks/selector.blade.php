    ...
    <div class="row">
        <div class="col-md-10">
            <fieldset>
                ...
                <div class="row">
                    ...
                    <div class="col-md-3">
                        <div class="form-group">
                            <label for="subject_id" class="col-form-label font-weight-bold">{{ __('ui.subject') }}:</label>
                            <select required id="subject_id" name="subject_id" data-placeholder="{{ __('ui.select_class_first') }}" class="form-control select-search">
                              @if($selected)
        ...
        <div class="col-md-2 mt-4">
            <div class="text-right mt-1">
                <button type="submit" class="btn btn-primary">{{ __('ui.manage_marks') }} <i class="icon-paperplane ml-2"></i></button>
            </div>
        </div>
